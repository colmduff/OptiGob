...
This module contains the BioEnergyBudget class, which is used to calculate various bioenergy-related metrics
...
class BioEnergyBudget:
    ...
    def get_biomethane_co2_total(self):
        ...
        """
        ad_ag_co2 = self.get_ad_ag_co2_emission()
        return ad_ag_co2
    ...
    def get_biomethane_ch4_total(self):
        ...
        """
        ad_ag_ch4 = self.get_ad_ag_ch4_emission()
        return ad_ag_ch4
    ...
    def get_biomethane_n2o_total(self):
        ...
        """
        ad_ag_n2o = self.get_ad_ag_n2o_emission()
        return ad_ag_n2o