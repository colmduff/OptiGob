...
Ready to contribute? Here's how to set up `optigob` for local development.

1. Download a copy of `optigob` locally.
2. Install `optigob` using `poetry`:
...
Please note that the `optigob` project is released with a
